...
var instrTests = []suite{
	...
	{
		name:     "ADD R0, R1",
		regs:     regs{R0: 000001, R1: 000001, R7: 001000},
		core:     core{001000: 060001},
		steps:    1,
		wantregs: regs{R0: 000001, R1: 000002, R7: 001002},
	},
	{
		name:     "ADD R0, R1",
		regs:     regs{R0: 000001, R1: 0177777, R7: 001000},
		core:     core{001000: 060001},
		steps:    1,
		wantregs: regs{R0: 000001, R1: 0000000, R7: 001002, PS: 000005},
	},
	{
		name:     "ADD R0, R1",
		regs:     regs{R0: 0177777, R1: 0177777, R7: 001000},
		core:     core{001000: 060001},
		steps:    1,
		wantregs: regs{R0: 0177777, R1: 0177776, R7: 001002, PS: 000011},
	},
	{
		name:     "ADD R0, R1",
		regs:     regs{R0: 0077777, R1: 0077777, R7: 001000},
		core:     core{001000: 060001},
		steps:    1,
		wantregs: regs{R0: 0077777, R1: 0177776, R7: 001002, PS: 000012},
	},
	{
		name:     "ADC R0",
